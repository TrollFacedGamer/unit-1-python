...
#integer
integer = 19
#check if integer is even and greater then 10
...
person_age = 18
#variable if person is a student
is_student = False
#check if person is under 18 or is a student
...
#check if given fruit is in list
if fruit in fruits:
...
#ask for year and convert it to integer
...
#ask for weight and convet it to int
...
if weight < 0:
    print("error")
#print weight time 5 dollars if destination_zone = A
elif destination_zone == "A":
    print("$" + str(weight * 5))
#print weight time 7 dollars if destination_zone = B
...
side_lenghts = input("give the lenght of a triangle's sides")
